...
##DEFAULT_COMMANDS
    ...
    if message.content.lower().startswith('!comandos'):
        embed = discord.Embed(
            ...
            description="!serverinfo » Veja as informações do servidor\n"
                        ...
                        "!ajuda » Veja as informações básicas do servidor Perfect Network\n"
    ...
    if message.content.lower().startswith('!ajuda'):
        embed = discord.Embed(
            ...
            color=0x0d488a,
            description="**Seja bem-vindo ao discord da rede Perfect Network! Segue abaixo algumas informações da rede que possa te ajudar!**\n"
                        "\n"
                        "IP: mc-perfect.com.br\n"
                        "\n"
                        "Site: [clique aqui!](https://mc-perfect.com.br)\n"
                        "\n"
                        "Twitter da rede: [clique aqui!](https://twitter.com/RedesPerfect)\n"
                        "\n"
                        "Loja: **Em breve!**\n"
                        "\n"
                        "Fórum: **Em breve!**\n"
    ...
    if message.content.lower().startswith('!convite'):
     ...
     await client.send_message(message.author, "Seu convite para o discord do Perfect Network é: {}".format(invite.url))
...
##STAFF+
    ...
    #mute
        ...
        await client.send_message(message.channel, embed=embedmsg)
        cargo = discord.utils.get(message.author.server.roles, name='💀 USUÁRIO PUNIDO')
